...
int main(){
    ...
    showBTree(root);
    Solution solution;
    string encode_answer = solution.serialize(root);
    cout << "encode_answer: " << encode_answer << endl;

    TreeNode* decode_answer = solution.deserialize(encode_answer);
    showBTree(decode_answer);
}